parcelRequire = function (e, r, n, t) { var i = "function" == typeof parcelRequire && parcelRequire, o = "function" == typeof require && require; function u(n, t) { if (!r[n]) { if (!e[n]) { var f = "function" == typeof parcelRequire && parcelRequire; if (!t && f) return f(n, !0); if (i) return i(n, !0); if (o && "string" == typeof n) return o(n); var c = new Error("Cannot find module '" + n + "'"); throw c.code = "MODULE_NOT_FOUND", c } p.resolve = function (r) { return e[n][1][r] || r }, p.cache = {}; var l = r[n] = new u.Module(n); e[n][0].call(l.exports, p, l, l.exports, this) } return r[n].exports; function p(e) { return u(p.resolve(e)) } } u.isParcelRequire = !0, u.Module = function (e) { this.id = e, this.bundle = u, this.exports = {} }, u.modules = e, u.cache = r, u.parent = i, u.register = function (r, n) { e[r] = [function (e, r) { r.exports = n }, {}] }; for (var f = 0; f < n.length; f++)u(n[f]); if (n.length) { var c = u(n[n.length - 1]); "object" == typeof exports && "undefined" != typeof module ? module.exports = c : "function" == typeof define && define.amd ? define(function () { return c }) : t && (this[t] = c) } return u }({
    ...
    }, { "./util": "BHXf", "eventemitter3": "UASB" }], "HCdX": [function (require, module, exports) {
        "use strict"; exports.__esModule = !0; var e = require("./util"), t = require("./adapter"); function o(e, t) { "addTrack" in t ? e.getTracks().forEach(function (o) { t.addTrack(o, e) }) : "addStream" in t && t.addStream(e) } exports.Negotiator = { pcs: { data: {}, media: {} }, queue: [] }, exports.Negotiator._idPrefix = "pc_", exports.Negotiator.startConnection = function (t, r) { var i = exports.Negotiator._getPeerConnection(t, r); if (t.pc = t.peerConnection = i, "media" === t.type && r._stream && o(r._stream, i), r.originator) { if ("data" === t.type) { var n = {}; e.util.supports.sctp || (n = { reliable: r.reliable }); var a = i.createDataChannel(t.label, n); t.initialize(a) } exports.Negotiator._makeOffer(t) } else exports.Negotiator.handleSDP("OFFER", t, r.sdp) }, exports.Negotiator.higherBandwidthSDP = function (e) { var t = navigator.appVersion.match(/Chrome\/(.*?) /); if (t && (t = parseInt(t[1].split(".").shift())) < 31) { var o = e.split("b=AS:30"); if (o.length > 1) return o[0] + "b=AS:102400" + o[1] } return e }, exports.Negotiator._getPeerConnection = function (t, o) { exports.Negotiator.pcs[t.type] || e.util.error(t.type + " is not a valid connection type. Maybe you overrode the `type` property somewhere."), exports.Negotiator.pcs[t.type][t.peer] || (exports.Negotiator.pcs[t.type][t.peer] = {}); var r; exports.Negotiator.pcs[t.type][t.peer]; return o.pc && (r = exports.Negotiator.pcs[t.type][t.peer][o.pc]), r && "stable" === r.signalingState || (r = exports.Negotiator._startPeerConnection(t)), r }, exports.Negotiator._startPeerConnection = function (o) { e.util.log("Creating RTCPeerConnection."); var r = exports.Negotiator._idPrefix + e.util.randomToken(), i = {}; "data" !== o.type || e.util.supports.sctp ? "media" === o.type && (i = { optional: [{ DtlsSrtpKeyAgreement: !0 }] }) : i = { optional: [{ RtpDataChannels: !0 }] }; var n = new t.RTCPeerConnection(o.provider.options.config, i); return exports.Negotiator.pcs[o.type][o.peer][r] = n, exports.Negotiator._setupListeners(o, n, r), n }, exports.Negotiator._setupListeners = function (t, r, i) { var n = t.peer, a = t.id, c = t.provider; e.util.log("Listening for ICE candidates."), r.onicecandidate = function (o) { o.candidate && (e.util.log("Received ICE candidates for:", t.peer), c.socket.send({ type: "CANDIDATE", payload: { candidate: o.candidate, type: t.type, connectionId: t.id }, dst: n })) }, r.oniceconnectionstatechange = function () { switch (r.iceConnectionState) { case "failed": e.util.log("iceConnectionState is disconnected, closing connections to " + n), t.emit("error", new Error("Negotiation of connection to " + n + " failed.")), t.close(); break; case "disconnected": e.util.log("iceConnectionState is disconnected, closing connections to " + n); break; case "completed": r.onicecandidate = e.util.noop } }, r.onicechange = r.oniceconnectionstatechange, e.util.log("Listening for data channel"), r.ondatachannel = function (t) { e.util.log("Received data channel"); var o = t.channel; c.getConnection(n, a).initialize(o) }, e.util.log("Listening for remote stream"), r.ontrack = function (t) { e.util.log("Received remote stream"); var r = t.streams[0], i = c.getConnection(n, a); "media" === i.type && o(r, i) } }, exports.Negotiator.cleanup = function (t) { e.util.log("Cleaning up PeerConnection to " + t.peer); var o = t.pc; o && (o.readyState && "closed" !== o.readyState || "closed" !== o.signalingState) && (o.close(), t.pc = null) }, exports.Negotiator._makeOffer = function (t) { var o = t.pc, r = function (r) { e.util.log("Created offer."), !e.util.supports.sctp && "data" === t.type && t.reliable && (r.sdp = exports.Negotiator.higherBandwidthSDP(r.sdp)); o.setLocalDescription(r).then(function () { return e.util.log("Set localDescription: offer", "for:", t.peer), void t.provider.socket.send({ type: "OFFER", payload: { sdp: r, type: t.type, label: t.label, connectionId: t.id, reliable: t.reliable, serialization: t.serialization, metadata: t.metadata, browser: e.util.browser }, dst: t.peer }) }).catch(function (o) { return function (o) { "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != o && (t.provider.emitError("webrtc", o), e.util.log("Failed to setLocalDescription, ", o)) }(o) }) }; o.createOffer(t.options.constraints).then(function (e) { return r(e) }).catch(function (o) { return function (o) { t.provider.emitError("webrtc", o), e.util.log("Failed to createOffer, ", o) }(o) }) }, exports.Negotiator._makeAnswer = function (t) { var o = t.pc, r = function (r) { e.util.log("Created answer."), !e.util.supports.sctp && "data" === t.type && t.reliable && (r.sdp = exports.Negotiator.higherBandwidthSDP(r.sdp)); o.setLocalDescription(r).then(function () { return e.util.log("Set localDescription: answer", "for:", t.peer), void t.provider.socket.send({ type: "ANSWER", payload: { sdp: r, type: t.type, connectionId: t.id, browser: e.util.browser }, dst: t.peer }) }).catch(function (o) { t.provider.emitError("webrtc", o), e.util.log("Failed to setLocalDescription, ", o) }) }; o.createAnswer().then(function (e) { return r(e) }).catch(function (o) { t.provider.emitError("webrtc", o), e.util.log("Failed to create answer, ", o) }) }, exports.Negotiator.handleSDP = function (o, r, i) { i = new t.RTCSessionDescription(i); var n = r.pc; e.util.log("Setting remote description", i); n.setRemoteDescription(i).then(function () { return e.util.log("Set remoteDescription:", o, "for:", r.peer), void ("OFFER" === o && exports.Negotiator._makeAnswer(r)) }).catch(function (t) { r.provider.emitError("webrtc", t), e.util.log("Failed to setRemoteDescription, ", t) }) }, exports.Negotiator.handleCandidate = function (o, r) { var i = r.candidate, n = r.sdpMLineIndex; o.pc.addIceCandidate(new t.RTCIceCandidate({ sdpMLineIndex: n, candidate: i })), e.util.log("Added ICE candidate for:", o.peer) };
    ...
    }, { "./util": "BHXf", "eventemitter3": "UASB", "./negotiator": "HCdX" }], "T9kO": [function (require, module, exports) {
        var global = arguments[3];
    ...
    }, { "./util": "BHXf", "eventemitter3": "UASB", "./negotiator": "HCdX", "reliable": "aYFJ" }], "Hxpd": [function (require, module, exports) {
    ...
    }, { "./util": "BHXf", "eventemitter3": "UASB", "./socket": "wJlv", "./mediaconnection": "dbHP", "./dataconnection": "GBTQ" }], "iTK6": [function (require, module, exports) {
    ...
    }, { "./util": "BHXf", "./adapter": "sXtV", "./socket": "wJlv", "./mediaconnection": "dbHP", "./dataconnection": "GBTQ", "./peer": "Hxpd", "./negotiator": "HCdX", "js-binarypack": "lHOc" }]
}, {}, ["iTK6"], null)
